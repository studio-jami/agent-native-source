const messages = {
  ...
  agents: {
    ...
    selected: "已選取",
    openExperiment: "開啟進行中的實驗",
    productExperiments: "產品實驗",
    productExperimentsDescription: "建立並監督由就緒功能旗標支援的產品實驗。",
    createExperiment: "建立實驗",
    createExperimentDescription:
      "開始曝光前，請選擇就緒應用程式及其已註冊旗標。",
    experimentsUnavailable: "實驗無法使用",
    experimentsEmpty: "還沒有產品實驗",
    experimentsEmptyDetail: "有明確假設和轉換事件時即可建立。",
    selectExperiment: "選擇實驗以檢查其生命週期和結果。",
    openFlag: "開啟功能旗標",
    resultsWarning: "結果品質需要注意",
    noHypothesis: "未記錄假設。",
    start: "開始",
    pause: "暫停",
    complete: "完成",
    emergencyOff: "緊急關閉",
    emergencyOffTitle: "立即關閉此實驗？",
    changeExperimentTitle: "變更實驗生命週期？",
    changeExperimentDescription:
      "這會變更即時實驗行為。確認前請檢查目前發布範圍。",
    confirm: "確認",
    name: "名稱",
    hypothesis: "假設",
    appId: "應用程式 ID",
    flagKey: "功能旗標",
    primaryEventName: "主要轉換事件",
    treatmentPercentage: "處理組百分比",
    enableForMe: "只為我啟用",
    turnOff: "關閉",
    selectApp: "選擇就緒應用程式",
    selectFlag: "選擇已註冊旗標",
