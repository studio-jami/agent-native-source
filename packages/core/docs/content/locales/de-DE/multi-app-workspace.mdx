...
- [Agent-Ressourcen](/docs/workspace) – die Anpassungsebene (`AGENTS.md`, `LEARNINGS.md`, persönlicher Speicher, skills, benutzerdefinierte Agenten), die jede App im Arbeitsbereich gemeinsam nutzt.
