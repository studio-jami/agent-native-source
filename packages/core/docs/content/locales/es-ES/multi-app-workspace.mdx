...
- [Recursos del Agente](/docs/workspace): la capa de personalización (`AGENTS.md`, `LEARNINGS.md`, memoria personal, skills, agentes personalizados) que comparte cada aplicación en el espacio de trabajo.
