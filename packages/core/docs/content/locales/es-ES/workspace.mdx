...
**¿Qué documento de espacio de trabajo?** Esta página cubre **Recursos del Agente**: la capa de personalización del agente. Para conocer la forma de implementación (un monorepo, muchas aplicaciones), consulte [Multi-App Workspaces](/docs/multi-app-workspace); para conocer la gobernanza (quién revisa, aprueba y es propietario de qué), consulte [Workspace Governance](/docs/workspace-management).
...
## Pestaña Recursos {#workspace-panel}
