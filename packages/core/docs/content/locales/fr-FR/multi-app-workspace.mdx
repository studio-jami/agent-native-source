...
- [Ressources de l'agent](/docs/workspace) : la couche de personnalisation (`AGENTS.md`, `LEARNINGS.md`, mémoire personnelle, skills, agents personnalisés) que chaque application de l'espace de travail partage.
