...
**Quel document d'espace de travail ?** Cette page couvre les **Ressources de l'agent** – la couche de personnalisation de l'agent. Pour la forme de déploiement (un monorepo, plusieurs applications), voir [Multi-App Workspaces](/docs/multi-app-workspace) ; pour la gouvernance (qui examine, approuve et possède quoi), voir [Workspace Governance](/docs/workspace-management).
...
## Onglet Ressources {#workspace-panel}
