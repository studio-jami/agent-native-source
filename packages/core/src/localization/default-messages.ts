...
const messages = {
  ...
  featureFlags: {
    ...
    immediateOff: "Turn off now",
    advanced: "Advanced targeting",
    advancedFor: "Advanced targeting for {{name}}",
    targetingDescription: "Replace the targeting rules for {{name}}.",
    noFlags: "No feature flags are registered for this app.",
    defaultOn: "Code default: on",
    defaultOff: "Code default: off",
    runtime: "Runtime state",
    rollout: "Current rollout",
    modeLabel: "Availability",
    emailsLabel: "Exact email addresses",
    orgIdsLabel: "Organization IDs",
    percentageLabel: "Percentage rollout",
